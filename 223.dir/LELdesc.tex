...
\medskip\noindent \htmladdnormallink{Note 216}{216.html} gives a
...
\htmlref{Python binding}{LEL:PYTHONC}. It means that in Python a
...
The documentation in the classes
 \htmladdnormallink{LCRegion}{../html/classcasa_1_1LCRegion.html},
 \htmladdnormallink{LCSlicer}{../html/classcasa_1_1LCSlicer.html}, and
 \htmladdnormallink{WCRegion}{../html/classcasa_1_1WCRegion.html})
...
However, when using the true \htmlref{C++ interface}{LEL:PYTHONC}
...
more about this in the \htmlref{interface}{LEL:PYTHONC} section.
...
The LEL interface in Python is provided in the
\htmladdnormallink{pyrap.images}{../../../pyrap/docs/pyrap_images.html}
...
Here follows a sample Python session showing some of the LEL
