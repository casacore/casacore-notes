...
See \htmlref{below}{TAQL:CONSTANTS} for a discussion of these constants.
...
(which is very similar to Python and Glish):
\begin{itemize}
  ...
  \item The imaginary part of a Complex constant is formed by a Double
       ...
       Double constant as the real part. E.g.
       \begin{verbatim}
       1.5 + 2j
       2i+1.5            is identical
       \end{verbatim}
  ...
  \item A Regex constant can be given in three flavours:
        ...
        \item as an extended regular expression matching part of a string.
          ...
          is equal to
              ...
              \end{verbatim}
        \end{itemize}
        A pattern or regex constant can be followed by an \texttt{i} to
        indicate case-insensitive matching (e.g. \texttt{p/data*/i}.
...
Some functions have 2 names. One name is the CASA/Glish name, while the
...
\htmladdnormallink{Regex}{../html/classcasa_1_1Regex.html}.
...
are similar to those used in Python or Glish.
...
\item
  ...
  {../../../pyrap/docs/pyrap_tables\#pyrap.tables.table.query} function in module
  ...
  The other function that can be used is \texttt{taql} (or
  \texttt{tablecommand}). The
