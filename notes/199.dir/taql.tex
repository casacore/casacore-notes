...
\item
  The Python interface is formed by the
  \htmladdnormallink{pyrap.tables}{../../../pyrap/docs/pyrap\_tables.html}
  package. It looks the same as the Glish interface.
  By default, \texttt{pyrap.tables} will use the Python style for a TaQL
  statement.
  For example:
  \begin{verbatim}
