...
COORDINATE\_AXES & Double(3,3) & m & DIRECTION & Local coordinate system \\
ELEMENT\_OFFSET & Double(3, \na) & m & POSITION & Offset per element \\
({\it BEAM\_ID}) & Int &  &  & Beam id.\\
ELEMENT\_FLAG & Bool(\na, NUM\_POL) &  & & Flag of elements in array, for each polarization\\
}
\begin{description}
...
\item[COORDINATE\_AXES] (cartesian) direction vectors in ITRF (or measure defined) describing the
