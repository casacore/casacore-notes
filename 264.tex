...
software packages using casa/casacore code. The version 2.0 (Note 229;
Kemball and Wieringa 2000) of the MS has been in use since 2000 in
...
document we try to not do that. We realize that a given data structure
