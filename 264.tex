...
\item{{\bf Data Description}The concept of data description is being
    ...
    confusing. SPECTRAL_WINDOW_ID and POLARIZATION_ID are explicit
...
\item{{\bf removal of FLAG_CATEGORY}

}
\item{{\bf Removal of SIGMA}
}

\item{{\bf Removal of FLAG_ROW}

}

\item{{\bf Redefinition of WEIGHT to be WEIGHT_SPRCTRUM}
}

\item{{\bf Versioning of (DATA, WEIGHT, FLAG) triplet}

}

\item{{\bf Merging of DATA and FLOAT_DATA}
}

\item{{\Replacement of DATA_DESC_ID}
