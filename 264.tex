...
SPECTRAL\_WINDOW table and introduces new optional subtables
for describing BDA data.
...
table in the MS definition. Section \ref{sec:msv3} gives a full
definition of the v3.0 MS format.
...
\definetable[main]{MAIN table: Data, coordinates and flags}
{
\defline{\bf Columns}
\defline{\em Keywords}
...
\definetable{EPHEMERIDES: Ephemerides information}{
...
\definetable[spectral-window]{SPECTRAL\_WINDOW: Spectral window description}{
\defline{\bf Columns}
\defline{\em Key}
SPECTRAL\_WINDOW\_ID & Int & & & Spectral window id\\
\defline{\em Data description columns}
...
EFFECTIVE\_BW & Double(NUM\_CHAN) & Hz & & The effective noise bandwidth of each spectral channel.\\
RESOLUTION & Double(NUM\_CHAN) & Hz & & The effective spectral resolution of each channel.\\
TOTAL\_BANDWIDTH & Double & Hz & & The total bandwidth for this window.\\
